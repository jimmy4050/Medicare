        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              <HeartPulse className="h-8 w-8 text-medical-400" />
              <span className="text-2xl font-display font-bold">MediCore</span>
            </div>
            <p className="text-medical-200 leading-relaxed">
            ...
            <div className="flex space-x-4">
              <a href="#" className="p-2 bg-medical-800 rounded-full hover:bg-medical-700 transition-colors"><Facebook className="w-5 h-5" /></a>
              <a href="#" className="p-2 bg-medical-800 rounded-full hover:bg-medical-700 transition-colors"><Twitter className="w-5 h-5" /></a>
              <a href="#" className="p-2 bg-medical-800 rounded-full hover:bg-medical-700 transition-colors"><Linkedin className="w-5 h-5" /></a>
            </div>
          </div>

          <div>
            <h3 className="text-lg font-bold mb-6">Quick Links</h3>
            <ul className="space-y-4 text-medical-200">
